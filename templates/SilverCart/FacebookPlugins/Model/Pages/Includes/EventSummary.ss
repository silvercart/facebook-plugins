<section class="bg-white border shadow-sm my-4">
    ...
    <div class="py-3 px-4">
        <div class="row">
        <% if $Cover %>
            <div class="col-12 col-sm-4 mb-3 mb-sm-0"><a class="d-inline-block" href="{$Link}"><img src="{$Cover.ScaleMaxWidth(500).CropHeight(250).URL}" alt="{$Name}" class="img-fluid" /></a></div>
        <% end_if %>
            <div class="
                 <% if $Cover %>
                 col-12 col-sm-8
